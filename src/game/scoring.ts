...
export const wealthOf = (cash: number, savings: number, debt: number) => cash + savings - debt;
...
export function insertScore(scores: readonly HighScore[], score: HighScore): HighScore[] {
  return [...scores, score].sort((a, b) => b.wealth - a.wealth || (a === score ? -1 : b === score ? 1 : 0)).slice(0, 10);
}
